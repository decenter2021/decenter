function simulation_mc(model,methods,parameters)
    ...
    % MFH methods is initialized with OS methods
    if methods(4), methods(2) = true; end
    ...
    save(sprintf("./models/model%d/mc.mat",model),'tr_P_mc','methods','parameters');
